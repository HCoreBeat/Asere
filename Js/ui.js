...
function generarCategoriasHeader() {
  ...
  const iconosCategorias = {
    ...
    'enlatados': 'fas fa-box-open',
    'aderezos': 'fas fa-utensils',
    'agro': 'fas fa-box',
    'pastas & granos': 'fas fa-boxes',
    'lácteos': 'fas fa-cheese',
    'despensa': 'fa-solid fa-mug-hot',
    'bebidas': 'fas fa-coffee',
    'bebidas alcohólicas': 'fas fa-wine-bottle',
    'cakes': 'fas fa-birthday-cake',
    'confituras': 'fas fa-birthday-cake',
